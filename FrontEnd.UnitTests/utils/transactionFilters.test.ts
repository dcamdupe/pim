...
const transactions: Transaction[] = [
  { account: 'Everyday', date: '2026-07-01', description: 'Coffee Shop', category: 'Dining', amount: -4.5 },
  { account: 'Everyday', date: '2026-07-02', description: 'Salary', category: 'Income', amount: 2500 },
  { account: 'Credit Card', date: '2026-07-03', description: 'Whole Foods Market', category: '', amount: -86.42 },
  { account: 'Credit Card', date: '2026-07-04', description: 'Coffee Beans Direct', category: '', amount: -12 },
]
